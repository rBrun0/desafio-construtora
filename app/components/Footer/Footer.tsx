...
export const Footer = () => {
  return (
    <footer className="w-full bg-white relative">
      <motion.div
        className="absolute -top-7 left-[50%] -translate-x-[50%] flex items-center justify-center space-x-7 px-14 py-2 rounded-3xl bg-black text-mostard text-3xl"
      ...
      <motion.div
        className="text-mostard flex items-center justify-between px-32 py-11"
        initial={{ opacity: 0 }}
